...
export const builtinFunctions: FuncSignature[] = [
  ...
  { label: 'N', insertText: 'N', detail: 'Alignment: north' },
  { label: 'S', insertText: 'S', detail: 'Alignment: south' },
  { label: 'E', insertText: 'E', detail: 'Alignment: east' },
  { label: 'W', insertText: 'W', detail: 'Alignment: west' },
  { label: 'NE', insertText: 'NE', detail: 'Alignment: northeast' },
  { label: 'NW', insertText: 'NW', detail: 'Alignment: northwest' },
  { label: 'SE', insertText: 'SE', detail: 'Alignment: southeast' },
  { label: 'SW', insertText: 'SW', detail: 'Alignment: southwest' },
  { label: 'CCW', insertText: 'CCW', detail: 'Counter-clockwise' },
  { label: 'CW', insertText: 'CW', detail: 'Clockwise' },
  { label: 'NoAlign', insertText: 'NoAlign', detail: 'No alignment' },
  { label: 'Align', insertText: 'Align', detail: 'Align to direction' },
  { label: 'LeftSide', insertText: 'LeftSide', detail: 'Left side of path' },
  { label: 'RightSide', insertText: 'RightSide', detail: 'Right side of path' },
  { label: 'Relative', insertText: 'Relative', detail: 'Relative position' },
  { label: 'BeginPoint', insertText: 'BeginPoint', detail: 'Begin point of path' },
  { label: 'MidPoint', insertText: 'MidPoint', detail: 'Mid point of path' },
  { label: 'EndPoint', insertText: 'EndPoint', detail: 'End point of path' },
  { label: 'UnFill', insertText: 'UnFill', detail: 'Unfill area around label' },

  // === Standard library module names ===
  { label: 'graph', insertText: 'graph', detail: 'graph module' },
  { label: 'geometry', insertText: 'geometry', detail: 'geometry module' },
  { label: 'three', insertText: 'three', detail: 'three module' },
  { label: 'math', insertText: 'math', detail: 'math module' },
  { label: 'plain', insertText: 'plain', detail: 'plain module' },
  { label: 'markers', insertText: 'markers', detail: 'markers module' },
  { label: 'palette', insertText: 'palette', detail: 'palette module' },
  { label: 'contour', insertText: 'contour', detail: 'contour module' },
  { label: 'contour3', insertText: 'contour3', detail: 'contour3 module' },
  { label: 'solids', insertText: 'solids', detail: 'solids module' },
  { label: 'simplex', insertText: 'simplex', detail: 'simplex module' },
  { label: 'flowchart', insertText: 'flowchart', detail: 'flowchart module' },
  { label: 'feynman', insertText: 'feynman', detail: 'feynman module' },
  { label: 'stats', insertText: 'stats', detail: 'stats module' },
  { label: 'interpolate', insertText: 'interpolate', detail: 'interpolate module' },
  { label: 'ode', insertText: 'ode', detail: 'ode module' },
  { label: 'slopefield', insertText: 'slopefield', detail: 'slopefield module' },
  { label: 'tube', insertText: 'tube', detail: 'tube module' },
  { label: 'roundedpath', insertText: 'roundedpath', detail: 'roundedpath module' },
  { label: 'labelpath', insertText: 'labelpath', detail: 'labelpath module' },
  { label: 'labelpath3', insertText: 'labelpath3', detail: 'labelpath3 module' },
  { label: 'anim', insertText: 'anim', detail: 'animate module' },
  { label: 'embed', insertText: 'embed', detail: 'embed module' },
  { label: 'slide', insertText: 'slide', detail: 'slide module' },
  { label: 'babel', insertText: 'babel', detail: 'babel module' },
  { label: 'external', insertText: 'external', detail: 'external module' },
  { label: 'pattern', insertText: 'pattern', detail: 'patterns module' },
  { label: 'colormap', insertText: 'colormap', detail: 'colormap module' },
  { label: 'X11colors', insertText: 'X11colors', detail: 'X11colors module' },
  { label: 'texcolors', insertText: 'texcolors', detail: 'texcolors module' },
];
